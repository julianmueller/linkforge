...
def test_inertia_numerical_stability_epsilon():
...
def test_inertia_validation_rejection_threshold():
    ...
    with pytest.raises(ValueError, match="Inertia tensor violates triangle inequality"):
        InertiaTensor(
            ixx=1.0,
            ixy=0.0,
            ixz=0.0,
